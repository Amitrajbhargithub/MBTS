            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-auto py-3 wow fadeInLeft">
                    <div class="card-pricing">
                        ...
                        <div class="footer">
                            <a href="{{url('/checkout/business-basic-plan')}}" class="btn btn-outline rounded-pill">Buy Plan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-auto py-3 wow fadeInUp">
                    <div class="card-pricing active">
                        ...
                        <div class="footer">
                            <a href="{{url('/checkout/business-standard-plan')}}" class="btn btn-outline rounded-pill">Choose Plan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-auto py-3 wow fadeInRight">
                    <div class="card-pricing">
                        ...
                        <div class="footer">
                            <a href="{{url('/checkout/business-premium-plan')}}" class="btn btn-outline rounded-pill">Choose Plan</a>
                        </div>
                    </div>
                </div>
